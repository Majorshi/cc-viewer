...
// Read-only tools: no-decision, let Claude Code's own permission system handle
const READONLY_TOOLS = new Set(['Read', 'Glob', 'Grep', 'TaskList', 'TaskGet', 'TaskOutput', 'CronList']);
